    ...
    vThread(0)
{
    ...
    connect(ui->StartCap, &QPushButton::clicked, this, &MainWindow::StartCapture);
    connect(ui->checkFaceDetect, &QCheckBox::clicked, this, &MainWindow::CheckBoxChecked);
    connect(ui->checkEyesDetect, &QCheckBox::clicked, this, &MainWindow::CheckBoxChecked);
    connect(ui->checkLipsDetect, &QCheckBox::clicked, this, &MainWindow::CheckBoxChecked);
}
